...
const up = async (knex: Knex) => {
  // Add 'type' and 'fk_target_column_id' columns to atm_row_color_conditions table
...
const down = async (knex: Knex) => {
  // Remove 'type' and 'fk_target_column_id' columns from atm_row_color_conditions table
  await knex.schema.alterTable(MetaTable.ROW_COLOR_CONDITIONS, (table) => {
