...
/**
 * Bag of in-process Atmosphere handles passed to integration wrappers that need
 ...
 * under the `_atmosphere` slot. Wrappers should read it via the framework
 * getter (`this.atmosphere`) rather than touching the slot directly.
 */
