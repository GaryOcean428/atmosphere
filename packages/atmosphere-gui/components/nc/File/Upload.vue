...
<template>
  <div class="relative" :class="containerClass">
    <!-- Cropper Modal -->
    <AtModal v-if="showCropper" v-model:visible="showCropper" :mask-closable="false" wrap-class-name="!z-1050">
    ...
    >
      <AtButton type="secondary" size="small" @click="openFileDialog">
      ...
      <AtButton v-if="attachment" type="secondary" size="small" @click="handleDelete">
        <div class="flex gap-2 items-center">
