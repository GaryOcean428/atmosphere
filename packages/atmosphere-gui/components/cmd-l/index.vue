...
<template>
  <div v-if="vOpen" class="cmdk-modal cmdl-modal" :class="{ 'cmdk-modal-active cmdl-modal-active': vOpen }">
    <div ref="modalEl" class="cmdk-modal-content cmdl-modal-content relative h-[25.25rem]">
      ...
      <div class="flex items-center bg-atm-bg-default w-full z-[50]">
        <div class="text-sm px-4 py-2 text-atm-content-gray-muted">{{ $t('labels.recentViews') }}</div>
      </div>
      <div class="flex flex-col shrink grow overflow-hidden shadow-[rgb(0_0_0_/_50%)_0px_16px_70px] max-w-[650px] p-0">
        <div class="scroll-smooth actions overflow-auto atm-scrollbar-md mb-10 relative mx-0 px-0 py-2">
          <div v-if="filteredViews.length < 1" class="flex flex-col p-4 gap-4 items-center justify-center text-sm">
            ...
            />
            <div class="text-atm-content-gray-muted">{{ $t('labels.noRecentViews') }}</div>
          </div>
          <div v-else class="flex flex-col cmdOpt-list w-full">
            ...
            >
              <div class="cmdk-action-content">
                ...
                <div class="flex w-1/2 justify-end text-atm-content-gray-subtle2">
