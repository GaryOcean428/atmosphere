...
<template>
  <div data-testid="atm-settings-subtab-migrate-to-v3" class="item-card flex flex-col w-full">
    <div class="text-atm-content-gray-emphasis font-semibold text-lg">{{ $t('labels.migrateToV3') }}</div>
    ...
    <div class="text-atm-content-gray-subtle2 mt-2 leading-5">
      ...
      <a href="https://docs.atmosphere.dev/" target="_blank" rel="noopener noreferrer" class="text-atm-content-brand">
        {{ $t('msg.learnMore') }}
      </a>
    </div>

    <div class="mt-6">
      <div class="text-atm-content-gray-emphasis font-semibold mb-3">What changes after migration</div>
      <div class="flex flex-col gap-2 mb-6">
        <div class="flex items-start gap-2">
          <span class="text-atm-content-gray text-sm">•</span>
          <span class="text-atm-content-gray text-sm">
        ...
        <div class="flex items-start gap-2">
          <span class="text-atm-content-gray text-sm">•</span>
          <span class="text-atm-content-gray text-sm">Designed for improved scalability and long-term compatibility</span>
        </div>
      </div>

      <div class="text-atm-content-gray-emphasis font-semibold mb-3">Important considerations</div>
      ...
      <div class="bg-atm-bg-gray-light border-l-4 border-atm-content-brand p-3 mb-6">
        <span class="text-atm-content-gray text-sm">
      ...
      <div class="flex gap-2">
        <AtButton size="medium" type="primary" data-testid="atm-migrate-to-v3-button" @click="isModalVisible = true">
    ...
    <GeneralModal v-model:visible="isModalVisible" size="small" centered>
      <div class="flex flex-col p-4 md:p-6">
        <div class="flex flex-row pb-2 mb-4 font-semibold text-lg text-atm-content-gray-emphasis">
          {{ $t('labels.migrateToV3') }}
        </div>

        <div class="mb-2 text-atm-content-gray-emphasis font-medium">Are you sure you want to migrate this base to v3?</div>

        <div class="mb-4 text-atm-content-gray text-sm">
          This change upgrades the base to the latest architecture and API version.
        </div>

        <div v-if="base" class="mb-4">
          <div class="text-atm-content-gray-emphasis font-medium mb-2 text-sm">Before you continue</div>
        ...
        <div class="flex flex-row gap-x-2 mt-2 pt-4 border-t border-atm-border-gray-medium justify-end">
          <AtButton type="secondary" size="small" @click="isModalVisible = false"> {{ $t('general.cancel') }} </AtButton>
          ...
          <AtButton
            ...
            html-type="submit"
            :loading="isLoading"
            data-testid="atm-migrate-to-v3-confirm-btn"
            @click="migrateToV3"
          >
