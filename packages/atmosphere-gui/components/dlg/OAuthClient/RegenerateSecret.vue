  ...
  <GeneralModal v-model:visible="vModel" size="small" class="!w-[440px]">
    <div class="flex flex-col gap-4 p-4 p-6">
      <div class="flex items-start gap-3">
        <GeneralIcon icon="alertTriangle" class="flex-none !text-atm-orange-500 h-5 w-5 mt-0.5" />
        <div class="flex flex-col gap-1">
          <h3 class="font-bold text-base text-atm-content-gray-emphasis">Regenerate Client Secret</h3>
      ...
      <div class="flex justify-end gap-2 mt-2">
        <AtButton type="secondary" size="small" @click="vModel = false"> {{ $t('general.cancel') }} </AtButton>
        <AtButton type="danger" size="small" :loading="isRegenerating" @click="onRegenerate">
