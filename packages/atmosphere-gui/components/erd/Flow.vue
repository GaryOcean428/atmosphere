...
<template>
  <VueFlow v-model="elements" class="atm-erd-flow">
    <Controls
      class="bg-transparent rounded-lg shadow-md border-1 border-atm-border-gray-medium"
      :position="PanelPosition.BottomLeft"
      :show-fit-view="false"
      :show-interactive="false"
    >
      <template #control-zoom-in>
        <div class="atm-erd-zoom-btn rounded-t-md" @click="internalZoomIn">
          <GeneralIcon icon="plus" />
        </div>
      </template>
      <template #control-zoom-out>
        <div class="atm-erd-zoom-btn border-t-1 border-atm-border-gray-medium rounded-b-lg" @click="internalZoomOut">
