...
<template>
  <div
    ...
    class="px-2 py-1 bg-atm-bg-gray-extralight text-atm-content-gray-muted text-xs border border-atm-border-gray-medium min-w-12 sm:max-w-16 h-8 flex items-center justify-center"
  >
