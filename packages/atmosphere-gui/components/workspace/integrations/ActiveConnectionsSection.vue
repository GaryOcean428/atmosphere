...
<template>
  <div v-show="filteredConnections.length" class="atm-active-connections-section" style="container-type: inline-size">
    <!-- Section header -->
    <div class="flex items-center justify-between mb-4">
      <div class="flex items-center gap-2">
        <h3 class="text-sm font-weight-700 text-atm-content-gray-subtle mb-0">
      ...
      <AtButton
        ...
        type="link"
        size="small"
        class="!text-atm-content-brand !p-0 !h-auto !min-h-0"
    ...
    <div class="atm-connection-cards-grid grid grid-cols-1 gap-3">
      ...
      <div
        ...
        v-e="['c:integration:view-all-connections']"
        class="atm-connection-overflow-card"
        @click="emits('view-all')"
      >
        ...
        <div v-else-if="toBeDeletedIntegration" class="w-full flex flex-col text-atm-content-gray">
          ...
          >
            ...
            <ul class="!list-disc ml-6 mb-0">
              <li v-for="(source, idx) of toBeDeletedIntegration.sources" :key="idx" class="marker:text-atm-content-gray-muted">
    ...
    <AtModal v-model:visible="successConfirmModal.isOpen" centered size="small" @keydown.esc="successConfirmModal.isOpen = false">
      <div class="flex gap-4">
        ...
        <div class="flex flex-col gap-3">
          ...
          <div class="text-sm text-atm-content-inverted-secondary">{{ successConfirmModal.description }}</div>
          <a
            target="_blank"
...
.atm-active-connections-section {
