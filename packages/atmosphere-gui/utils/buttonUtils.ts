export const buttonColorMap = {
  solid: {
    brand: {
      base: { background: 'var(--atm-brand-accent)', text: '#FFFFFF' },
      hover: { background: 'var(--atm-brand-accent-hover)', text: '#FFFFFF' },
      loader: 'var(--atm-brand-accent)',
      disabled: { background: 'var(--atm-bg-gray-light)', text: 'var(--atm-content-gray-disabled)' },
    },
    red: {
  ...
  light: {
    ...
    gray: {
      base: { background: 'var(--atm-bg-gray-extralight)', text: 'var(--atm-content-gray-subtle2)' },
      hover: { background: 'var(--atm-bg-gray-light)', text: 'var(--atm-content-gray-subtle2)' },
      disabled: { background: 'var(--atm-bg-gray-light)', text: 'var(--atm-content-gray-disabled)' },
      loader: 'var(--atm-content-gray-subtle2)',
    },
  },
  text: {
    brand: {
      base: { background: 'transparent', text: 'var(--atm-brand-accent)' },
      hover: { background: 'var(--atm-bg-gray-light)', text: 'var(--atm-brand-accent)' },
      disabled: { background: 'var(--atm-bg-gray-light)', text: 'var(--atm-content-gray-disabled)' },
      loader: 'var(--atm-brand-accent)',
    },
    red: {
      base: { background: 'transparent', text: '#FF4A3F' },
      hover: { background: 'var(--atm-bg-gray-light)', text: '#FF4A3F' },
      disabled: { background: 'var(--atm-bg-gray-light)', text: 'var(--atm-content-gray-disabled)' },
      loader: '#FF4A3F',
    },
    green: {
      base: { background: 'transparent', text: '#27D665' },
      hover: { background: 'var(--atm-bg-gray-light)', text: '#27D665' },
      disabled: { background: 'var(--atm-bg-gray-light)', text: 'var(--atm-content-gray-disabled)' },
      loader: '#27D665',
    },
    maroon: {
      base: { background: 'transparent', text: '#B33771' },
      hover: { background: 'var(--atm-bg-gray-light)', text: '#B33771' },
      disabled: { background: 'var(--atm-bg-gray-light)', text: 'var(--atm-content-gray-disabled)' },
      loader: '#B33771',
    },
    blue: {
      base: { background: 'transparent', text: '#36BFFF' },
      hover: { background: 'var(--atm-bg-gray-light)', text: '#36BFFF' },
      disabled: { background: 'var(--atm-bg-gray-light)', text: 'var(--atm-content-gray-disabled)' },
      loader: '#36BFFF',
    },
    orange: {
      base: { background: 'transparent', text: '#FA8231' },
      hover: { background: 'var(--atm-bg-gray-light)', text: '#FA8231' },
      disabled: { background: 'var(--atm-bg-gray-light)', text: 'var(--atm-content-gray-disabled)' },
    ...
    pink: {
      ...
      hover: { background: 'var(--atm-bg-gray-light)', text: '#FC3AC6' },
      disabled: { background: 'var(--atm-bg-gray-light)', text: 'var(--atm-content-gray-disabled)' },
      loader: '#FC3AC6',
    },
    purple: {
      base: { background: 'transparent', text: '#7D26CD' },
      hover: { background: 'var(--atm-bg-gray-light)', text: '#7D26CD' },
      disabled: { background: 'var(--atm-bg-gray-light)', text: 'var(--atm-content-gray-disabled)' },
      loader: '#7D26CD',
    },
    yellow: {
      base: { background: 'transparent', text: '#fcbe3a' },
      hover: { background: 'var(--atm-bg-gray-light)', text: '#fcbe3a' },
      disabled: { background: 'var(--atm-bg-gray-light)', text: 'var(--atm-content-gray-disabled)' },
      loader: '#fcbe3a',
    },
    gray: {
      base: { background: 'transparent', text: 'var(--atm-content-gray-muted)' },
      hover: { background: 'var(--atm-bg-gray-light)', text: 'var(--atm-content-gray-muted)' },
      disabled: { background: 'var(--atm-bg-gray-light)', text: 'var(--atm-content-gray-disabled)' },
      loader: 'var(--atm-content-gray-muted)',
    },
  },
} as const
...
export const getButtonColors = (
  ...
  if (!themeColors) {
    return isHovered && !isDisabled
      ? { background: 'var(--atm-brand-accent-hover)', text: '#FFFFFF', loader: 'var(--atm-brand-accent)' }
      : { background: 'var(--atm-brand-accent)', text: '#FFFFFF', loader: 'var(--atm-brand-accent)' }
  }
