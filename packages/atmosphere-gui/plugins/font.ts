export default defineNuxtPlugin(() => {
  ...
  // and remove 'atm-fonts-not-loaded' class from <html> element

  try {
    document.documentElement?.classList.add('atm-fonts-not-loaded')
    ...
    if (!materialFont || !materialFont.loaded) {
      document.documentElement?.classList.remove('atm-fonts-not-loaded')
      return
    }
