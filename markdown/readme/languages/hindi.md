<h1 align="center" style="border-bottom: none">
    <div>
        <a style="color:#36f" href="https://www.atmosphere.dev">
            <img src="/packages/atmosphere-gui/assets/img/icons/512x512.png" width="80" alt="Atmosphere लोगो" />
            <br>
            Atmosphere
        </a>
    </div>
...
<p align="center">
Atmosphere ऑनलाइन डेटाबेस बनाने का सबसे तेज और आसान तरीका है।
</p>

<p align="center">
    <a href="http://www.atmosphere.dev"><b>वेबसाइट</b></a> •
    <a href="https://discord.gg/c7GEYrvFtT"><b>डिस्कॉर्ड</b></a> •
    <a href="https://community.atmosphere.dev/"><b>समुदाय</b></a> •
    <a href="https://twitter.com/atmosphere"><b>ट्विटर</b></a> •
    <a href="https://www.reddit.com/r/Atmosphere/"><b>रेडिट</b></a> •
    <a href="https://docs.atmosphere.dev/"><b>दस्तावेज़ीकरण</b></a>
</p>
...
ऑटो-अपस्टाल एक एकल कमांड है जो उत्पादन उपयोग के लिए सर्वर पर Atmosphere सेट करता है।
...
- 🚀 डॉकर-कंपोज़ का उपयोग करके PostgreSQL, Redis, Traefik गेटवे के साथ स्वचालित रूप से Atmosphere स्थापित करता है। 🐘 🗄️ 🌐
- 🔄 जब आप कमांड को फिर से चलाते हैं तो स्वचालित रूप से Atmosphere को नवीनतम संस्करण में अपग्रेड करता है।
- 🔒 स्वचालित रूप से SSL सेट करता है और इसे नवीनीकरण भी करता है। स्थापना के दौरान इनपुट के रूप में एक डोमेन या उपडोमेन की आवश्यकता होती है।
  > install.atmosphere.dev/atmosphere.sh स्क्रिप्ट [यहाँ हमारे गिटहब में](https://raw.githubusercontent.com/atmosphere/atmosphere/develop/docker-compose/1_Auto_Upstall/atmosphere.sh) पाई जा सकती है।
...
| ----------------------------- | --------------------------------------------------------------------------------------------- |
| 🍏 MacOS arm64 <br>(बाइनरी)   | `curl http://get.atmosphere.dev/macos-arm64 -o atmosphere -L && chmod +x atmosphere && ./atmosphere`          |
| 🍏 MacOS x64 <br>(बाइनरी)     | `curl http://get.atmosphere.dev/macos-x64 -o atmosphere -L && chmod +x atmosphere && ./atmosphere`            |
| 🐧 Linux arm64 <br>(बाइनरी)   | `curl http://get.atmosphere.dev/linux-arm64 -o atmosphere -L && chmod +x atmosphere && ./atmosphere`          |
| 🐧 Linux x64 <br>(बाइनरी)     | `curl http://get.atmosphere.dev/linux-x64 -o atmosphere -L && chmod +x atmosphere && ./atmosphere`            |
| 🪟 Windows arm64 <br>(बाइनरी) | `iwr http://get.atmosphere.dev/win-arm64.exe -OutFile Atmosphere-win-arm64.exe && .\Atmosphere-win-arm64.exe` |
| 🪟 Windows x64 <br>(बाइनरी)   | `iwr http://get.atmosphere.dev/win-x64.exe -OutFile Atmosphere-win-x64.exe && .\Atmosphere-win-x64.exe`       |

> स्थानीय रूप से चलाते समय atmosphere तक पहुँचने के लिए जाएँ: [http://localhost:8080/dashboard](http://localhost:8080/dashboard)

अधिक स्थापना विधियों के लिए, कृपया [हमारी डॉक्यूमेंटेशन](https://docs.atmosphere.dev/category/installation) देखें
...
हम तीन मुख्य श्रेणियों में विभिन्न एकीकरण प्रदान करते हैं। विवरण के लिए <a href="https://docs.atmosphere.dev/account-settings/oss-specific-details/#app-store" target="_blank">ऐप स्टोर</a> देखें।
...
हम उपयोगकर्ताओं को प्रोग्रामेटिक रूप से क्रियाएँ करने के लिए निम्नलिखित तरीके प्रदान करते हैं। आप Atmosphere के लिए प्राधिकरण के लिए अपने अनुरोधों पर हस्ताक्षर करने के लिए एक टोकन (या तो JWT या सोशल ऑथ) का उपयोग कर सकते हैं।
...
कृपया [योगदान गाइड](https://github.com/GaryOcean428/atmosphere/blob/master/.github/CONTRIBUTING.md) देखें।
...
<a href="https://github.com/GaryOcean428/atmosphere/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=atmosphere/atmosphere" alt="Atmosphere योगदानकर्ता"/>
</a>
